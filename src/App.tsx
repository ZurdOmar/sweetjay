    ...
    <div className="min-h-screen bg-dark-bg text-white overflow-x-hidden selection:bg-neon-green selection:text-black">
      ...
      <section id="inicio" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden py-24 md:py-32">
        ...
        <div className="relative z-10 flex flex-col items-center gap-12 w-full max-w-4xl px-4">
          ...
          >
            ...
            <a
              href="https://www.tiktok.com/@s.weetjay?_r=1&_t=ZS-94c05EMqOA6"
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-3 bg-black text-white px-6 py-3 rounded-full font-bold uppercase tracking-wider border border-white/20 hover:bg-[#00f2ea] hover:text-black hover:border-[#00f2ea] transition-all transform hover:scale-105 shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.tiktok.com/@s.weetjay?_r=1&_t=ZS-94c05EMqOA6" target="_blank" rel="noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-neon-pink hover:text-black transition-colors">
      ...
      <footer className="py-12 border-t border-white/10 bg-black text-center flex flex-col items-center gap-6">
        ...
        <div className="mt-4 flex justify-center gap-6 opacity-50">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="hover:text-neon-pink transition-colors cursor-pointer">
            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
          </svg>
